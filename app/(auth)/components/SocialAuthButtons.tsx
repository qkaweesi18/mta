    ...
    <div className="mt-6 space-y-4">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-black px-2 text-gray-500 font-bold tracking-widest uppercase">Or continue with</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <button
          ...
          className="flex items-center justify-center w-full px-4 py-3 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/30 transition-colors skew-x-[-12deg]"
